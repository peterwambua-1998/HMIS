...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $doctorcnt = DB::table('users')->where('user_type', '=', 'doctor_consultation')->count(DB::raw('distinct id'));
        $generalcnt = DB::table('users')->where('user_type', '=', 'doctor_dentist')->count(DB::raw('distinct id'));
