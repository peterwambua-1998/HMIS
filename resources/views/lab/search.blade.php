    ...
    <div class="col-md-12">
        ...
        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('Lab')}} <small class="ml-2" style="font-weight: bold">(Check queue for patient number)</small></h3>
            </div>
            
            <div class="box-body">
                <div class="pl-5 pr-5 pb-5">
                    <h3>{{__('Enter Patient Name To Begin Lab Test')}}</h3>
                    <label class="mr-2" style="display: none">
                            ...
                            {{__('Patient ')}} <span class="ml-4" style="font-size: 14px; color: rgb(100, 100, 100);"> (Check Queue for Patient Number)</span>
                    </label>
                    
                        <input required type="text"  class="form-control" id="keyword" name="keyword"
                            placeholder="Enter Patient Name" style="margin-top: 2px">
                        
                        <button id="search-btn" type="submit" class="btn btn-success mt-3 text-center">Search</button>
