        ...
        <div class="box box-successbox box-success">
            ...
            <div class="box-body">
                <div class="pl-5 pr-5 pb-5">
                    ...
                    <button type="button" id="search-btn" class="btn btn-success mt-3 text-center">Search</button>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-md-12">
                            <div class="box box-successbox box-success">
                                <div class="box-body pl-5 pr-5 pb-5">
                                    <form action="{{route('commencetriage')}}" method="post">
                                        @csrf
