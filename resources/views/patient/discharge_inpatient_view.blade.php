    ...
    <form method="post" action="{{ route('save_disinpatient') }}" class="form-horizontal">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                <label for="patient_id" class="col-sm-2 control-label">{{__('Patient No')}}</label>
                <div class="col-sm-2">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <select required class="form-control" name="discharge_status" id="dichargeStatus">
                        <option  value="to attend clinic">To Attend Clinic</option>
                        <option value="referral">Referral</option>
                        <option value="diseased">Diseased</option>
                        <option selected value="to go home">To Go Home</option>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10" id="al-box">
                    <input type="text"  value="" required class="form-control" id="medofs2" name="reg_medicalofficer2"
                        placeholder="" />
                </div>
            </div>
...
<div class="row mt-5 pt-5">
    <div class="col-md-1"></div>
    <div class="col-md-10">
<div class="box box-success" id="disinpatient1">
    <div class="box-header with-border">
    ...
    <div class="box-body">
        <div class="form-group">
            <label for="pid" class="control-label" style="font-size:18px">{{__('Patient No:')}}</label>
