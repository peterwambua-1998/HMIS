            ...
            <table class="table table-striped table-bordered table-active">
                <thead>
                    <tr>
                        ...
                        <th scope="col" style="text-align:center;vertical-align:middle;font-size:18px" rowspan="2">Price
                        </th>
                ...
                <tbody id="bodyData">
                    ...
                    <tr >
                        ...
                        <td style="text-align:center;font-size:15px;" >
                            ...
                            <br>
                            <input type="number" id="qty{{$med->id}}" class="qtyclass form-control" data-price="{{ Medicine::find($med->medicine_id)->price }}" >
                        </td>
                        <td style="text-align:center;font-size:15px;">
                            <label for="">Total Price</label><br>
                            <input type="number" class="subTotal" readonly class="form-control">
                        </td>
...
<script>
    ...
    $('body').on('input','.qtyclass', function(){
        var qty = $(this).val() - 0;

        var price = $(this).attr('data-price');

        var next1 = $(this).parent();

        var next = next1.next().find('.subTotal');
        
        var t = qty * price;
        //var myinput = next.next();
        next.val(t)
    ...
    function calTotal () {
        var TotalValue = 0;
        var TotalPriceArr = $('#bodyData tr .subTotal').get();
