...
<div @if (session()->has('regpsuccess') || session()->has('regpfail')) style="margin-bottom:0;margin-top:3vh" @else
    style="margin-bottom:0;margin-top:2vh" @endif class="row">
    <div class="col-md-12">
        ...
        <div class="alert alert-success alert-dismissible">
            ...
            <h4>Registed Patient No: {{session()->get('pid')}} <button class="btn btn-primary" onclick="myCopy({{session()->get('pid')}})">Copy</button></h4>
            <h4>Registed Patient Name: {{session()->get('pname')}}</h4>
            {{---
            <button
            ...
            <form method="post" action="{{ route('patient_register') }}" class="form-horizontal">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  maxlength="12"
                                class="form-control" name="reg_pnic" placeholder="ID/PP/Military No">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="box-footer">
                        <input type="submit" class="btn btn-success pull-right" value="{{__('Register')}}">
