...
<div class="box box-success" id="reginpatient2" style="display:none">
...
<div class="row mt-1 pt-5">
    <div class="col-md-12">
<div class="box box-success" id="reginpatient1">
    <div class="box-header with-border">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
                <button type="button" class="btn btn-success" onclick="registerinpatientfunction()">{{__('Enter to begin registration')}}</button>
        </div>
        {{-- </div> --}}
    </div>
    <!-- /.box-body -->
