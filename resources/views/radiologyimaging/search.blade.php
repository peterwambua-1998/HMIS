...
@section('title', 'Radiology/Imaging Search')
    ...
    <div class="col-md-12">
        ...
        <div class="box box-successbox box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{__('Radiology and Imaging')}} <small class="ml-2" style="font-weight: bold">(Check queue for patient name)</small></h3>
            </div>
            <div class="box-body">
                <div class="pl-5 pr-5 pb-5">
                    <h3>{{__('Enter Patient Name To Begin Test')}}</h3>
                    <label class="mr-2" style="display: none">
                        ...
                        {{__('Patient Name')}} <span class="ml-4" style="font-size: 14px; color: rgb(100, 100, 100);"> (Check Queue for Patient Name)</span>
                    </label>
                            ...
                            <div class="col-md-12">
                                <div class="box box-successbox box-success">
                                    <div class="box-body pl-5 pr-5 pb-5">
                                        <form action="{{route('commenceradiology')}}" method="post">
                                            @csrf
