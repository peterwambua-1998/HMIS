                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select required id="user-type" type="select" class="form-control" name="user_type"
                                ...
                                <option value="doctor_dialysis">Dialysis</option>
                                <option value="doctor_radiology_imaging">Radiology Imaging</option>
                                <option value="reception">Receptionist</option>
                                <option value="doctor_physiotherapy">Physiotherapy</option>
                                <option value="doctor_consultation">Consultation</option>
                                <option value="nurse">Nurse</option>
                                <option value="doctor_dentist">Dentist</option>
                                <option value="doctor_counselling">Counselling</option>
