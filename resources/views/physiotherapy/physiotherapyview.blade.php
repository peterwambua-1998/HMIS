...
@section('title', 'Physiothrapy')

@section('content_title',__("Patient Physiothrapy"))
    ...
    <div class="col-xs-10">
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <button class="btn btn-primary" id="addLabResults">Add Physiothrapy Results</button>
            </div>
            <!-- /.box-body -->
        </div>
        <!-- /.box -->
...
<div class="row" id="myhiddenrow">
    ...
    <div class="col-xs-10">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">{{__('Physiothrapy Results Form')}}</h3>
            </div>
            <div class="box-body">

                <form class="form-horizontal" action="{{route('addphysiotherapy')}}" method="POST">
                    @csrf
                    ...
                    <input type="hidden" value="physiotherapy" name="billing_for" />
...
<div class="row" id="createchannel4">
    ...
    <div class="col-xs-10">
        <div class="box box-info">
            <div class="box-header">
                <h3 class="box-title">{{__('Physiothrapy History')}}</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div class="row">
                    <div class="col-md-12">
                       @foreach ($Physiothrapy as $dialysi)
