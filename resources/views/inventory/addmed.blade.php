        ...
        <div class="box box-info">
            ...
            <form method="post" action="{{ route('medinventoryaddmed') }}" class="form-horizontal">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">{{__('Reorder Level')}} <span
                                style="color:red">*</span></label>
                        <div class="col-sm-10">
                            <input type="text" required class="form-control" name="reorder_level"
                    ...
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">{{__('Reorder Level')}} <span
                                style="color:red">*</span></label>
                        <div class="col-sm-10">
                            <input type="date" required class="form-control" name="exp_date">
                        </div>
                    </div>
