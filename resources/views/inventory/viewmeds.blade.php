           ...
           @method('PATCH')
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input class="form-control"  type="text"  name="reorder_level" required value="{{$med->reorder_level}}">

                    <br>
                    <label for="">Expirey Date</label>
                    <input class="form-control"  type="date"  name="exp_date" required value="{{$med->exp_date}}">
